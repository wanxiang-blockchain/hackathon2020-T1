...
import SignManageTag from './messageList.css';
const { TabPane } = Tabs;
const { Option } = Select;
    ...
    state = {
        ...
        columns: [
            ...
            },
            {
                ...
                render: (text, record) => {
                    return <span>
                        <a onClick={this.showDeleteConfirm.bind(null, record.id)}>通过</a>
                        <a onClick={this.showDeleteConfirm.bind(null, record.id)}>拒绝</a>
